...
impl TranslationsGeneral {
    ...
    fn get_info(&self, key: &str) -> Option<(&'static str, usize)> {
        match key {
            ...
            "language__change_template" => Some((self.language__change_template, 358)),
            "language__set_default" => Some((self.language__set_default, 359)),
            "language__title_change" => Some((self.language__title_change, 360)),
