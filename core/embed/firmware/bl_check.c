...
extern const void _binary_embed_firmware_bootloaders_bootloader_bin_start;
extern const void _binary_embed_firmware_bootloaders_bootloader_bin_size;
...
void check_and_replace_bootloader(void) {
  ...
  const uint32_t *data =
      (const uint32_t
           *)&_binary_embed_firmware_bootloaders_bootloader_bin_start;
  const uint32_t len =
      (const uint32_t)&_binary_embed_firmware_bootloaders_bootloader_bin_size;
